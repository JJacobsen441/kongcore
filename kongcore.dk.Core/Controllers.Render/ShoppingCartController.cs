...
{
    public class ShoppingCartController : Umbraco.Web.Mvc.RenderMvcController
    {
        ...
        public ActionResult ShoppingCart()
        {
            try
            {
                ...
                BIZ_ShoppingCart biz_shop = new BIZ_ShoppingCart();
                DTO_ShoppingCart dto = biz_shop.ToDTO(helper);
                ...
                //return View("ShoppingCart", (List<DTO_Order>)con.Session["ShoppingCart"]);
            }
            catch (Exception _e)
            {
